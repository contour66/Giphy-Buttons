...
var animate = sportsImage.attr('data-animate', results[i].images.fixed_height.url);
//This variable sets the attribute for the img to the animated gif result path from the  Giphy API. It will be use to call later in our If else statement.
var still = sportsImage.attr('data-still', results[i].images.fixed_height_still.url);
